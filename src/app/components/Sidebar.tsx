    ...
    const sections = [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'الوحدات الدراسية', href: '/units', roles: ['admin', 'editor'] },
          { name: 'إدارة الأسئلة', href: '/questions', roles: ['admin', 'editor'] },
          { name: 'إستخراج الاسئلة', href: '/extract', roles: ['admin', 'editor'] },
