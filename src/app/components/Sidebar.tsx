    ...
    const sections = [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'الوحدات الدراسية ', href: '/mat0erial', roles: ['admin', 'editor'] },
          { name: 'إدارة الأسئلة', href: '/mate9rial', roles: ['admin', 'editor'] },
          { name: 'إستخراج الاسئلة', href: '/qu9iz', roles: ['admin', 'editor'] },
